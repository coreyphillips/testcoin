...
This means one can have an always-on bitcoind instance running, and another local bitcoind/testcoin-qt instance which connects to this node and receives blocks from it.
