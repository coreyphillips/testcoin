...
<context>
    ...
    <message>
        ...
        <translation>К testcoin: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть Bitcoin.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
for example: alertnotify=echo %%s | mail -s "Bitcoin Alert" admin@foo.com
        ...
        <translation>Для использования bitcoind или опции testcoin-qt -server, вы должны установить опцию rpcpassword в конфигурационном файле:
 %s
