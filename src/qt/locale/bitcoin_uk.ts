...
<context>
    ...
    <message>
        ...
        <translation>Повідомлення, що було додане до testcoin:URI та буде збережено разом з транзакцією для довідки. Примітка: Це повідомлення не буде відправлено в мережу Bitcoin.</translation>
    </message>
    <message>
        <source>Pay To:</source>
        <translation>Отримувач:</translation>
...
for example: alertnotify=echo %%s | mail -s "Bitcoin Alert" admin@foo.com
        ...
        <translation>Для використання bitcoind, або testcoin-qt з параметром -server, ви повинні встановити rpcpassword в файлі конфігурації:
%s
