Bitcoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/testcoin/files/Bitcoin/testcoin-0.8.4/
...
guess attempts; fixes https://github.com/testcoin/testcoin/issues/2838
(CVE-2013-4165)
...
Linux: clicking on testcoin: links was broken if you were using
