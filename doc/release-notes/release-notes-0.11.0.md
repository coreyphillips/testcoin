Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://testcoin.org/bin/testcoin-core-0.11.0/>
...
For example, add the following to `testcoin.conf`:
...
related to the blockchain in the testcoin system: the raw blocks as received over 
...
For an example script see [testcoin-submittx](https://github.com/laanwj/testcoin-submittx).
...
- #6269 `95aca44` gitian: Use the new testcoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add testcoin logo to about screen
...
- #5809 `46bfbe7` Add testcoin-cli man page
...
- #6098 `7708fcd` Update Windows resource files (and add one for testcoin-tx)
