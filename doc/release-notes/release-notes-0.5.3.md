...
http://sourceforge.net/projects/testcoin/files/Bitcoin/testcoin-0.5.3/
...
http://gitorious.org/testcoin/bitcoind-stable/archive-tarball/v0.5.3#.tar.gz
...
Handle invalid Bitcoin URIs using "testcoin://" instead of "testcoin:".
