Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/testcoin/files/Bitcoin/testcoin-0.7.0/
...
source-only tarballs/zipballs directly from there:
  https://github.com/testcoin/testcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/testcoin/testcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the testcoin-qt package:
  sudo apt-get install testcoin-qt
...
Core testcoin handling and blockchain database
...
* Ensure a changed testcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for testcoin-qt.exe
* (Windows only): add meta-data to testcoin-qt.exe (e.g. description)
