...
- [Building Bitcoin](#building-testcoin)
...
in the testcoin repository under 'Fetch and build inputs' to install sources which require
...
BTCPATH=/some/root/path/testcoin.git
SIGPATH=/some/root/path/testcoin-detached-sigs.git
